...
function  ProductModal({ product, currency, discountedPrice, finalProductPrice, finalDiscountedPrice, show, onHide, wishlistItem, compareItem }) {
  ...
  const [productStock, setProductStock] = useState(
    product.variation ? product.variation[0].size[0].item_stock : product.item_stock
  );
                          ...
                          >
                            <input
                              ...
                              onChange={() => {
                                ...
                                setProductStock(single.size[0].item_stock);
                                setQuantityCount(1);
                              }}
                            />
                                  ...
                                  >
                                    <input
                                      ...
                                      onChange={() => {
                                        ...
                                        setProductStock(singleSize.item_stock );
                                        setQuantityCount(1);
                                      }}
                                    />
